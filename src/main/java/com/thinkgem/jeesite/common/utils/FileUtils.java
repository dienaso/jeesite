...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	/**
	 * 
	 * @param url 网络图片地址，http开头 
	 * @param outFile 保存地址 
	 * 
	 */
	public static String copyUrlImg(String srcUrl, String descFileName) throws Exception {  
        //new一个URL对象  
        ...
        descFileName = FileUtils.path(descFileName);
        File imageFile = new File(descFileName);  
        //创建输出流  
