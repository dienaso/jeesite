...
public class ImageUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		// ImageUtils.scale2("D:\\a.jpg", "D:\\b.jpg", 300, 300);
		ImageUtils.zoomImage("D:\\a.jpg", "D:\\b.jpg", 300, 300);// false
																	// 缩小
																	// true
																	// 放大
	...
	public final static Image scale2(String srcImageFile, String result, int height, int width) {
		Image itemp = null;
		BufferedImage tag = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
		try {
			double ratio = 0.0; // 缩放比例
	 ...
	 */
	public static Image zoomImage(String src, String dest, int w, int h) throws Exception {
	...
	public final static void pressMainInfo(String pressImg, String applicantCn, String businessType, String tmName,
		...
		try {
			...
			if (pressImg != null && !pressImg.equals("")) {
				...
				// int wideth_biao = src_biao.getWidth(null);
				// int height_biao = src_biao.getHeight(null);
				Image src_biao = scale2(pressImg, "", 300, 300);
				g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_ATOP, 1.0f));
	...
	public final static void pressSimilarInfo(String pressImg, String sTmName, String sCls, String sRegNoAndStatus,
		...
		try {
			...
			if (pressImg != null && !pressImg.equals("")) {
				...
				Image src_biao = scale2(pressImg, "", 250, 250);
				g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_ATOP, 1.0f));
